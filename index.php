  ...
  <div class="container">
    <nav class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        ...
        <a href="#" class="navbar-brand scroll-top logo  animated bounceInLeft"><b><i></i>Uganda Police</b></a> </div>
      <!--/.navbar-header-->
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          <li class="active" id="firstLink"><a href="#home" class="scroll-link">Home</a></li>
          <li><a href="#services" class="scroll-link">Branches of service</a></li>
          <li><a href="#aboutUs" class="scroll-link">About Us</a></li>
          <li><a href="#work" class="scroll-link">Portfolio</a></li>
          <li><a href="#team" class="scroll-link">Team</a></li>
          <li><a href="#contactUs" class="scroll-link">Recrutment</a></li>
        </ul>
      </div>
      <!--/.navbar-collapse--> 
    </nav>
  ...
  <div class="banner-container"> <img src="images/banner-bg.jpg" alt="banner" />
    <div class="container banner-content">
      <div class="hero-text animated fadeInDownBig">
        <h1 class="responsive-headline" style="font-size: 40px;">Serve your Nation</h1>
...
<section id="services" class="page-section colord">
  <div class="container">
    <div class="heading text-center"> 
      <!-- Heading -->
      <h2>Branches of Service</h2>
      <p>Each department speacialises in a speacial feild.</p>
    </div>
    <div class="row"> 
      <!-- item -->
      <div class="col-md-3 text-center c1"> <i class="fa fa-life-ring fa-2x circle"></i>
        <h3><span class="id-color">Speacial Police Constable</span></h3>
        <p>Carry out critical police operations to secure the people and capture the wrong.</p>
      </div>
      <!-- end: --> 
      
      <!-- item -->
      <div class="col-md-3 text-center c2"> <i class="fa fa-plus-square fa-2x circle"></i>
        <h3><span class="id-color">Crimenal Intelligence Department</span></h3>
        <p>Do both intell and reconisense on any suspecious elements in society.</p>
      </div>
      <!-- end: --> 
      
      <!-- item -->
      <div class="col-md-3 text-center c1"> <i class="fa fa-female fa-2x circle"></i>
        <h3><span class="id-color">Investigation Department</span></h3>
        <p>Carryout proffetional investigation about crime in the country.</p>
      </div>
      <!-- end: --> 
      
      <!-- item -->
      <div class="col-md-3 text-center c2"> <i class="fa fa-child fa-2x circle"></i>
        <h3><span class="id-color">Social Surport Department</span></h3>
        <p>Help settle all family based problems in the country and protect socisl rights.</p>
      </div>
      <!-- end:--> 
    </div>
  </div>
...
<section id="aboutUs">
  <div class="container">
    <div class="heading text-center"> 
      <!-- Heading -->
      <h2>About Us</h2>
      <p>The Uganda police was formed in 1952.</p>
    </div>
    <div class="row feature design">
      <div class="six columns right">
        <h3>Proffesionized hierachy.</h3>
        <p>Since its formation the Uganda police has under gone a number of leaderships and continued to protect and serve. There has been a number of challenges  during this period of services but working hand in hand with our citizens and other deffence organisations in and out of the country, we have been able to over come them. This has lead to highly improved service delivery. </p>
        <p>On the quest of proffesionalism and better service delivery, Uganda police was millitarised so as to handle varst problems much better such as terrorisim. This has not only lead to better quality of service but also improved our independence. </p>
      </div>
...
<section id="team" class="page-section">
  <div class="container">
    <div class="heading text-center"> 
      <!-- Heading -->
      <h2>Senior Staff</h2>
      <p>Policing is based on good team work.</p>
    </div>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-6"> 
          ...
          <div class="team-member pDark"> 
            ...
            <h4>Kaihura</h4>
            <!-- Designation --> 
            <span class="pos">Commander</span> </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6"> 
          <!-- Team Member -->
          <div class="team-member pDark"> 
            ...
            <h4>Nabakoba</h4>
            <!-- Designation --> 
            <span class="pos">Spocks person</span> </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6"> 
          <!-- Team Member -->
          <div class="team-member pDark"> 
            ...
            <h4>Julius Omara</h4>
            <!-- Designation --> 
            <span class="pos">Head of operations</span> </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6"> 
          <!-- Team Member -->
          <div class="team-member pDark"> 
            ...
            <h4>Tuhingisibwe</h4>
            <!-- Designation --> 
            <span class="pos">Chief of investigations</span> </div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="heading text-center"> 
          ...
          <p>If you wish to join the Uganda Police fill in the form below.</p>
        </div>
      </div>
        ...
        <form method="post" action="" id="contactfrm" role="form">
          <div class="col-sm-4">
			...
			<div class="form-group">
              ...
              <input type="email" class="form-control" name="email" id="email" placeholder="+256 000 000" title="Please enter a valid Tel number">
			   <button name="submit" type="submit" class="btn btn-lg btn-primary" id="submit">Submit</button>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              <label for="comments">Talk about your academic qulifications</label>
...
<section class="copyright">
  <div class="container">
    <div class="row">
      <div class="col-sm-12 text-center"> Copyright 2014 | All Rights Reserved Uganda police">WebThemez.com</a> </div>
    </div>
    <!-- / .row --> 
  </div>
</section>
